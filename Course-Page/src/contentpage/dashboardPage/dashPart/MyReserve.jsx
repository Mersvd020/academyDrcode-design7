...
import ShowReservedDetail from "../../../component/dashComponent/showReservedDetail"
 ...
 const [filteredData, setFilteredData] = useState([]);
  ...
  ///////////////////////////////////
   ...
   const SortCourse = [...courseData].sort((a, b) => {
      if (filters.sortBy === "جدید ترین") return  new Date(b.startDate) -  new Date(a.startDate);
  ...
  const handleSearch = (value) => {
    ...
    const teacheName = item.teacher?.toLowerCase() || '';
                ...
                >
                    ...
                    <span className={`border-2 p-1 border rounded-4xl ${card?.accept ? "text-[green] bg-[green]/30":"  border-[gray]/30 bg-gray-300"}  `}>
                      ...
                      <span className=" flex flex-row justify-between lg:w-[5%] lg:gap-0 gap-2 lg:mt-0 lg:ml-0 ml-2 mt-5 ">
                         <button onClick={()=> deleteFavReserve(card?.reserveId)}> <img className="" src={Delete} /></button>
