    ...
    <div className="invoice-list-table-header w-100 py-2">
      <Row>
        <Col lg="6" className="d-flex align-items-center px-0 px-lg-1">
          ...
          <Button tag={Link} to="/news/create-News" color="primary">
            افزودن اخبار
          </Button>
        </Col>
        <Col
      ...
      if (value) {
        filteredData = filteredData.filter((news) => {
          ...
          return (
            ...
            news.describe?.toLowerCase().includes(searchLower) ||
            news.newsCatregoryName?.toLowerCase().includes(searchLower)
          );
        });
      }
