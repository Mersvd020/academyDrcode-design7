...
// ** Store & Actions
import { getCommentData } from "./store";
      ...
      if (value) {
        filteredData = filteredData.filter((comment) => {
          ...
          return (
            ...
            comment.describe?.toLowerCase().includes(searchLower) ||
            comment.miniDescribe?.toLowerCase().includes(searchLower) ||
            comment.userFullName?.toLowerCase().includes(searchLower)
          );
        });
      }
