...
const InvoiceList = () => {
  ...
  }, [dispatch, sort, value, sortColumn, currentPage, rowsPerPage, statusValue]) 
      ...
      if (statusValue) {
        filteredData = filteredData.filter(course => {
          if (statusValue === 'active') {
            return course.isActive && !course.isExpire
          } else if (statusValue === 'inactive') {
            return !course.isActive && !course.isExpire
          } else if (statusValue === 'expired') {
            return course.isExpire
          }
          return true
        })
      }
      ...
      if (value) {
        filteredData = filteredData.filter(course => {
          ...
          return (
            ...
            course.describe?.toLowerCase().includes(searchLower) ||
            course.miniDescribe?.toLowerCase().includes(searchLower) ||
      ...
      <Card>
        <div className='invoice-list-dataTable react-dataTable'>
          <DataTable
            ...
            responsive={true}
            onSort={handleSort}
            data={dataToRender().slice((currentPage - 1) * rowsPerPage, currentPage * rowsPerPage)}  
